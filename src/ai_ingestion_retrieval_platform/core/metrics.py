...
PERSISTENCE_OPERATIONS_TOTAL = Counter(
    "persistence_operations_total",
    "Total persistence transaction attempts.",
    ["operation", "result"],
)

PERSISTENCE_ERRORS_TOTAL = Counter(
    "persistence_errors_total",
    "Total persistence transaction failures by error category.",
    ["operation", "error_type"],
)

PERSISTENCE_TRANSACTION_DURATION_SECONDS = Histogram(
    "persistence_transaction_duration_seconds",
    "Persistence transaction duration in seconds.",
    ["operation"],
)
