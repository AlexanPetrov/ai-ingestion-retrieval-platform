...
async def test_metrics_route_exposes_project_metric_families(
    ...
    assert "parser_requests_total" in payload
    assert "parser_duration_seconds" in payload
    assert "parser_input_bytes" in payload
    assert "parser_extracted_chars" in payload
    assert "persistence_operations_total" in payload
    assert "persistence_errors_total" in payload
    assert "persistence_transaction_duration_seconds" in payload
